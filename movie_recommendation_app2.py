...
def get_recommendations(title):
    ...
    cosine_similarity_scores = list(enumerate(cosine_similarity2[index]))
...
# To run the program and open the wab page, enter "streamlit run movie_recommendation_app2.py" as input in terminal