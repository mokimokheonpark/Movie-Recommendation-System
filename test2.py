...
cosine_similarity = pickle.load(open("cosine_similarity2.pickle", "rb")) # used cosine_similarity2
...
# To run the program and open the wab page, enter "streamlit run app2.py" as input in terminal